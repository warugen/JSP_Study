...
public class EmpDao {
	...
	public ArrayList<EmpDto> getListEmps() {
	...
	public ArrayList<EmpDto> getSearch(String eName, String Job) {
		...
		try {
			...
			while (rs.next()) {
				...
				result.add(new EmpDto(empno, ename, job, mgr, hiredate, sal, comm, deptno));
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
		} finally {
